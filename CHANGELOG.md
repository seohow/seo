...
- Decided released skill artifacts are generated by CI from `v*` tags and tracked as GitHub Release assets. The generated release tree should keep a human-browsable `setup/<skill>/` and `categories/<category>/<skill>/` folder structure.
