...
1. **Anchor on the business.** Start from products, services, customer pains, and the questions customers actually ask before buying. Your `business_profile.md` is the right starting point. Resist the urge to start from a tool — tools amplify your seed list, they don't replace it.
