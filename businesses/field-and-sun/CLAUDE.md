...
> Working memory for the SEO program for **Field & Sun**. Any AI collaborator (Claude, Codex, etc.) reads this to orient quickly. Keep entries terse and update as decisions, learnings, constraints, or priorities surface.
>
