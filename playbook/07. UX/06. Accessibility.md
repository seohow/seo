...
- **[02. Mobile Optimization](02. Mobile Optimization.md)** — touch-target sizing overlaps with WCAG 2.5.5.
- **[03. UX Design](03. UX Design.md)** — accessibility constraints inform UX design choices.
- **[02. On-page SEO / 06. Image Optimization](../02. On-page SEO/06. Image Optimization.md)** — alt text overlaps SEO + accessibility.
- **[02. On-page SEO / 03. Header Structure](../02. On-page SEO/03. Header Structure.md)** — heading structure overlaps semantic HTML.
- **[03. Technical SEO / 02. Indexing](../03. Technical SEO/02. Indexing.md)** — semantic HTML helps both indexing + accessibility.
