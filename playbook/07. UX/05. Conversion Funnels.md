...
- **[03. UX Design](03. UX Design.md)** — UX-design issues are common funnel-leak causes.
- **[02. Mobile Optimization](02. Mobile Optimization.md)** — mobile funnel issues often dominate.
- **[01. Page Speed UX](01. Page Speed UX.md)** — speed regressions cause funnel anomalies.
- **[04. A/B Testing](04. AB Testing.md)** — ambiguous leak fixes are testable.
- **[05. Analytics / 04. Traffic Analysis](../05. Analytics/04. Traffic Analysis.md)** — funnel work consumes traffic-analysis output.
- **[05. Analytics / 06. Conversion Tracking](../05. Analytics/06. Conversion Tracking.md)** — funnel data depends on reliable tracking.
- **[06. Accessibility](06. Accessibility.md)** — accessibility issues sometimes manifest as funnel drops in specific cohorts.
