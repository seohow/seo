...
- **[09. AI SEO / 01. Content Optimization](01. Content Optimization.md)** — prose-level patterns. Citation-magnet content sits on top of clean content optimisation.
- **[09. AI SEO / 02. NLP Optimization](02. NLP Optimization.md)** — entity signals are a precondition for citation eligibility.
- **[09. AI SEO / 04. SERP Features](04. SERP Features.md)** — AI Overview citation overlaps heavily with featured-snippet territory; coordinate.
- **[09. AI SEO / 05. LLM Visibility](05. LLM Visibility.md)** — measurement layer; mandatory baseline + post-investment re-measurement.
- **[04. Content SEO / 03. Topic Clusters](../04. Content SEO/03. Topic Clusters.md)** — cluster-level investment is the right unit; citation lift compounds across the cluster.
- **[04. Content SEO / 08. Content Briefing](../04. Content SEO/08. Content Briefing.md)** — citation-magnet brief is a longer-form sibling of the standard brief.
- **[01. Strategy / 03. Competitor Analysis](../01. Strategy/03. Competitor Analysis.md)** — competitor citation share is part of the strategic input.
- **[06. Off-page SEO / 03. Digital PR](../06. Off-page SEO/03. Digital PR.md)** — promotion into the citation graph; original-evidence assets earn organic links from publishers, which feed AI authority.
- **[03. Technical SEO / 10. AI Crawler Management](../03. Technical SEO/10. AI Crawler Management.md)** — citation requires retrieval-bot access. Verify before investing.
