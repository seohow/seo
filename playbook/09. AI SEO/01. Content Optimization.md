...
- **[09. AI SEO / 02. NLP Optimization](02. NLP Optimization.md)** — entity-rich content reinforces AI extraction quality; this leaf operates at the prose level, NLP at the entity / signal level.
- **[09. AI SEO / 03. Generative SEO](03. Generative SEO.md)** — content patterns specifically for AI Overview / Perplexity citation; this leaf is the foundation, Generative SEO is the strategic layer.
- **[09. AI SEO / 04. SERP Features](04. SERP Features.md)** — featured-snippet and PAA optimisation overlap heavily with AI-citation patterns. The content-shape decisions cascade.
- **[04. Content SEO / 08. Content Briefing](../04. Content SEO/08. Content Briefing.md)** — bake AI-readiness patterns into the standard content brief.
- **[02. On-page SEO / 03. Header Structure](../02. On-page SEO/03. Header Structure.md)** — question-led H2s; logical H-hierarchy; anchor-able sections.
- **[02. On-page SEO / 07. Content Optimization](../02. On-page SEO/07. Content Optimization.md)** — page-level content-health patterns (this leaf is the AI-specific lens on the same content surface).
- **[03. Technical SEO / 10. AI Crawler Management](../03. Technical SEO/10. AI Crawler Management.md)** — content optimisation only matters if AI bots can reach the content. Verify retrieval-bot access first.
