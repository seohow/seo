...
- **[09. AI SEO / 02. NLP Optimization](02.%20NLP%20Optimization.md)** — entity-rich content reinforces AI extraction quality; this leaf operates at the prose level, NLP at the entity / signal level.
- **[09. AI SEO / 03. Generative SEO](03.%20Generative%20SEO.md)** — content patterns specifically for AI Overview / Perplexity citation; this leaf is the foundation, Generative SEO is the strategic layer.
- **[09. AI SEO / 04. SERP Features](04.%20SERP%20Features.md)** — featured-snippet and PAA optimisation overlap heavily with AI-citation patterns. The content-shape decisions cascade.
- **[04. Content SEO / 08. Content Briefing](../04.%20Content%20SEO/08.%20Content%20Briefing.md)** — bake AI-readiness patterns into the standard content brief.
- **[02. On-page SEO / 03. Header Structure](../02.%20On-page%20SEO/03.%20Header%20Structure.md)** — question-led H2s; logical H-hierarchy; anchor-able sections.
- **[02. On-page SEO / 07. Content Optimization](../02.%20On-page%20SEO/07.%20Content%20Optimization.md)** — page-level content-health patterns (this leaf is the AI-specific lens on the same content surface).
- **[03. Technical SEO / 10. AI Crawler Management](../03.%20Technical%20SEO/10.%20AI%20Crawler%20Management.md)** — content optimisation only matters if AI bots can reach the content. Verify retrieval-bot access first.
