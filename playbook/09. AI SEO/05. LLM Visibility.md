...
- **[09. AI SEO / 03. Generative SEO](03. Generative SEO.md)** — strategic plan consumes baseline + measures impact; tightly coupled.
- **[09. AI SEO / 01. Content Optimization](01. Content Optimization.md)** — content-readiness rewrites should drive measurable lift in subsequent audits.
- **[09. AI SEO / 02. NLP Optimization](02. NLP Optimization.md)** — entity / schema / knowledge-graph work shows up as mention quality lift over multiple quarters.
- **[09. AI SEO / 04. SERP Features](04. SERP Features.md)** — feature capture coordinates with AI Overview citation tracking.
- **[06. Off-page SEO / 04. Brand Mentions](../06. Off-page SEO/04. Brand Mentions.md)** — broader brand-mention monitoring on the open web; LLM visibility is the AI-search subset.
- **[06. Off-page SEO / 08. Reputation Management](../06. Off-page SEO/08. Reputation Management.md)** — branded SERP / AI Overview audits surface in both leaves; coordinate.
- **[01. Strategy / 03. Competitor Analysis](../01. Strategy/03. Competitor Analysis.md)** — competitor share-of-voice in LLM visibility complements organic competitor analysis.
- **[05. Analytics / 04. Traffic Analysis](../05. Analytics/04. Traffic Analysis.md)** — LLM-referral traffic appears in GA4; coordinate attribution definitions.
