...
- **Tooling landscape.** Manual probing (browser + spreadsheet) works for small query sets. For 30+ queries × 5-6 engines × quarterly cadence, dedicated tools — Profound, Otterly.AI, Peec.ai, Goodie, Ahrefs Brand Radar, and others — automate the probing (a fast-moving, well-funded category as of 2026; verify current vendors and coverage before committing). Most now also track Microsoft Copilot alongside ChatGPT, Claude, Perplexity, Gemini, and AI Overviews. Tool selection is a build-vs-buy call; for v1, manual probing with a structured spreadsheet is sufficient.
...
- **[09. AI SEO / 03. Generative SEO](03.%20Generative%20SEO.md)** — strategic plan consumes baseline + measures impact; tightly coupled.
- **[09. AI SEO / 01. Content Optimization](01.%20Content%20Optimization.md)** — content-readiness rewrites should drive measurable lift in subsequent audits.
- **[09. AI SEO / 02. NLP Optimization](02.%20NLP%20Optimization.md)** — entity / schema / knowledge-graph work shows up as mention quality lift over multiple quarters.
- **[09. AI SEO / 04. SERP Features](04.%20SERP%20Features.md)** — feature capture coordinates with AI Overview citation tracking.
- **[06. Off-page SEO / 04. Brand Mentions](../06.%20Off-page%20SEO/04.%20Brand%20Mentions.md)** — broader brand-mention monitoring on the open web; LLM visibility is the AI-search subset.
- **[06. Off-page SEO / 08. Reputation Management](../06.%20Off-page%20SEO/08.%20Reputation%20Management.md)** — branded SERP / AI Overview audits surface in both leaves; coordinate.
- **[01. Strategy / 03. Competitor Analysis](../01.%20Strategy/03.%20Competitor%20Analysis.md)** — competitor share-of-voice in LLM visibility complements organic competitor analysis.
- **[05. Analytics / 04. Traffic Analysis](../05.%20Analytics/04.%20Traffic%20Analysis.md)** — LLM-referral traffic appears in GA4; coordinate attribution definitions.
