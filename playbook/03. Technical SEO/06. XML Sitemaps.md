...
- **[05. Canonical Tags](05. Canonical Tags.md)** — sitemap and canonical strategy must align; this pair is usually audited together.
- **[02. Indexing](02. Indexing.md)** — sitemap submission is the cheapest discovery aid; sitemap state interacts heavily with GSC indexing reports.
- **[01. Crawlability](01. Crawlability.md)** — sitemap is a hint, not an override; crawl-blocked URLs in the sitemap are conflicts.
- **[02. On-page SEO / 04. URL Structure](../02. On-page SEO/04. URL Structure.md)** — URL conventions and sitemap inclusion rules align.
- **[09. Site Migration](09. Site Migration.md)** — migration involves coordinated sitemap updates (old + new sitemaps, redirect handling).
