...
- **[01. Crawlability](01. Crawlability.md)** — log analysis often confirms or contradicts what crawl-audit findings predict.
- **[02. Indexing](02. Indexing.md)** — pages Googlebot hits but doesn't index get cross-flagged here.
- **[05. Canonical Tags](05. Canonical Tags.md)** — most crawl-budget-waste fixes are canonical or robots-related.
- **[06. XML Sitemaps](06. XML Sitemaps.md)** — orphan URLs in logs are often a sitemap-omission diagnostic.
- **[09. Site Migration](09. Site Migration.md)** — log analysis pre/post-migration is the gold standard for verifying redirect coverage and recovery.
