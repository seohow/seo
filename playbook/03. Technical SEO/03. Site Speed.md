...
- **[02. On-page SEO / 06. Image Optimization](../02.%20On-page%20SEO/06.%20Image%20Optimization.md)** — the single biggest lever on most ecom sites; site-speed audits depend on image work.
- **[01. Crawlability](01.%20Crawlability.md)** — slow servers (high TTFB) compound into crawl budget waste on large sites.
- **[07. UX / 01. Page Speed UX](../07.%20UX/01.%20Page%20Speed%20UX.md)** — performance and the user-experience signals that flow from it (conversion, bounce, scroll depth).
- **[07. UX / 02. Mobile Optimization](../07.%20UX/02.%20Mobile%20Optimization.md)** — mobile-first measurement and the broader mobile experience.
- **[07. JavaScript SEO](07.%20JavaScript%20SEO.md)** — JS-heavy sites have specific INP and TTI patterns worth diagnosing separately.
