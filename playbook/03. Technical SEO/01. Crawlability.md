...
- **[02. Indexing](02. Indexing.md)** — the next link in the chain; once a page is crawlable, indexing decides whether it actually enters Google's index.
- **[05. Canonical Tags](05. Canonical Tags.md)** — canonicalisation interacts with crawl decisions; non-canonical URLs are still crawled but de-prioritised.
- **[06. XML Sitemaps](06. XML Sitemaps.md)** — sitemaps help Google discover pages but don't override crawl directives.
- **[08. Log File Analysis](08. Log File Analysis.md)** — the diagnostic that reveals what Googlebot actually does on the site, beyond what crawlers infer.
- **[02. On-page SEO / 05. Internal Linking](../02. On-page SEO/05. Internal Linking.md)** — internal-linking strategy directly affects crawl depth and orphan-page counts.
