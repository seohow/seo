...
- **[02. Indexing](02. Indexing.md)** — schema doesn't fix indexing problems but rich-result eligibility depends on indexing.
- **[02. On-page SEO / 03. Header Structure](../02. On-page SEO/03. Header Structure.md)** — FAQPage schema works best when the page has matching question-form H2s.
- **[02. On-page SEO / 06. Image Optimization](../02. On-page SEO/06. Image Optimization.md)** — Product schema requires image URLs; image quality and dimensions matter for the rich-result presentation.
- **[09. AI SEO / 04. SERP Features](../09. AI SEO/04. SERP Features.md)** — featured snippets, knowledge panels, AI Overviews — all of which schema increasingly feeds.
- **[09. AI SEO / 05. LLM Visibility](../09. AI SEO/05. LLM Visibility.md)** — entity-rich schema is one of the strongest signals for LLM-mediated visibility.
