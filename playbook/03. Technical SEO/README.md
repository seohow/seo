...
1. **[01. Crawlability](01.%20Crawlability/README.md)** — robots.txt, robots meta, x-robots-tag, server-response codes, internal linking depth, broken links. Whether Googlebot can reach the page at all.
2. **[02. Indexing](02.%20Indexing/README.md)** — once crawled, whether the page enters Google's index. Indexed-vs-not-indexed status, exclusion reasons, soft-404s, "discovered, not indexed."
3. **[03. Site Speed](03.%20Site%20Speed/README.md)** — Core Web Vitals (LCP, INP, CLS), TTFB, page-experience signals. The performance layer that affects ranking and conversion.
4. **[04. Schema Markup](04.%20Schema%20Markup/README.md)** — structured data (JSON-LD) that powers rich results, FAQ snippets, product cards, breadcrumbs, and AI Overview eligibility.
5. **[05. Canonical Tags](05.%20Canonical%20Tags/README.md)** — the `rel=canonical` signal that resolves duplicate content. Critical for ecom sites with parameter URLs and category-product variants.
6. **[06. XML Sitemaps](06.%20XML%20Sitemaps/README.md)** — the index of URLs you want Google to crawl. Should reflect canonical pages only and stay clean as the site grows.
...
- **[01. Strategy / 05. SEO Wins](../01.%20Strategy/05.%20SEO%20Wins/)** — many technical findings become P0 items in the wins backlog.
