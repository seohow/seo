...
4. **Triage by exclusion reason:**
   - Canonical-related → fix canonical signals (next leaf, [05. Canonical Tags](05. Canonical Tags.md)).
   - Soft-404 → either fix the page (real content) or return real 404/410.
   - Crawled – not indexed → quality issue. Audit content depth, internal links, page intent. May feed into [Content Optimization](../02. On-page SEO/07. Content Optimization.md).
...
- **[01. Crawlability](01. Crawlability.md)** — indexing depends on crawl. Crawl issues block indexing; this leaf is the next step.
- **[05. Canonical Tags](05. Canonical Tags.md)** — most canonical-related indexing problems get solved here.
- **[06. XML Sitemaps](06. XML Sitemaps.md)** — sitemap should reflect canonical, indexable URLs only.
- **[07. JavaScript SEO](07. JavaScript SEO.md)** — JS-rendered content is often the cause of "Crawled – not indexed" on JS-heavy sites.
- **[02. On-page SEO / 07. Content Optimization](../02. On-page SEO/07. Content Optimization.md)** — "Crawled – not indexed" often signals quality issues that on-page rework can solve.
