...
1. **Start from a classified list.** You need keywords with volume, intent, and page-type tags from [Search Intent](02. Search Intent.md). Don't cluster a raw keyword dump — you'll mix intents and produce broken clusters.
...
- **[Keyword Research](01. Keyword Research.md)** — produces the raw list this skill consumes.
- **[Search Intent](02. Search Intent.md)** — must run *before* clustering; intent tags are required input.
- **[Topic Clusters](../04. Content SEO/03. Topic Clusters.md)** — applies the pillar-and-cluster pattern to content architecture once keywords are clustered.
- **[Pillar Pages](../04. Content SEO/02. Pillar Pages.md)** — broad cluster topics often become pillars.
- **[Internal Linking](../02. On-page SEO/05. Internal Linking.md)** — clusters drive the internal linking strategy that ties hubs to spokes.
