...
4. **Annotate.** For each keyword, capture: search volume, difficulty, your current ranking (if any), and a quick read of intent (you'll do this formally in [Search Intent](../02.%20Search%20Intent/README.md)). Most tools let you bulk-export with these columns.
...
6. **Tag with page type.** Each keyword should map to one page type: product, collection, blog, FAQ, comparison, tool. This is the bridge to [Keyword Clustering](../04.%20Keyword%20Clustering/README.md).
...
- **[Search Intent](../02.%20Search%20Intent/README.md)** — the next step after keyword research; classifies each keyword by why someone is searching it.
- **[Competitor Analysis](../03.%20Competitor%20Analysis/README.md)** — reverse-engineers what keywords your competitors rank for, often the richest source of expansion.
- **[Keyword Clustering](../04.%20Keyword%20Clustering/README.md)** — groups your keyword universe into the page-level units you'll actually build.
