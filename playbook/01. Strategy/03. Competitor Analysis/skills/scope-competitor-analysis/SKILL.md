...
6. **Define the deliverable.** Specify exactly what comes out: a synthesis doc with sections for each lens, a per-competitor sub-doc, and a prioritised opportunity list. The opportunity list is the most important output — it's what feeds [SEO Wins](../../05.%20SEO%20Wins/README.md).
