...
1. **Anchor on the business.** Start from products, services, customer pains, and the questions customers actually ask before buying. Your business workspace (`businesses/<your-slug>/business_context.md` plus `seo_foundation.md`) is the right starting point. Resist the urge to start from a tool — tools amplify your seed list, they don't replace it.
...
- **[generate-seed-keywords](../../skills/strategy/generate-seed-keywords/SKILL.md)** — produces an initial seed keyword list (50–100 candidates) from your business context and SEO foundation, ready to be expanded in your keyword tool of choice.
