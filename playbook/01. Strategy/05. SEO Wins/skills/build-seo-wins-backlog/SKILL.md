...
**Inputs (abbreviated):** Cluster map with 28 clusters (15 already mapped to existing URLs, 13 needing new pages); competitor audit with 12 opportunities; GSC export showing 23 striking-distance keywords; 3 technical findings (duplicate canonicals on collection pages); 6 stale blog posts >18 months old.

**Output (abbreviated):** Consolidated backlog of 47 rows across 6 archetypes. Top 10 by score: 6 striking-distance keyword updates (each Effort 1, Score 8-12), 2 on-page wins (FAQ schema, internal linking from blog hub, Score 6-8), 1 collection-page revamp for /collections/refillable-laundry (Impact 5, Effort 3, Confidence 4, Score 6.7), 1 [ingredient] safety pillar page launch (Impact 5, Effort 5, Confidence 3, Score 3 but high strategic priority). 90-day sequence: Wk 1-2 ships 6 striking-distance + 2 on-page + 1 technical (10 wins). Wk 3-6 builds the collection revamp + 3 spoke posts. Wk 7-12 ships the pillar + remaining spokes + outreach to 8 publications. Weekly review every Monday, owner = founder. Risks include writer capacity and a flag that the technical canonical fix needs dev time not yet scoped.
