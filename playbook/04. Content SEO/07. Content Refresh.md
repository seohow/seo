...
- **[01. Blog Content](01. Blog Content.md)** — refresh and new content compete for the same content-team capacity. Balance them deliberately.
- **[05. Evergreen Content](05. Evergreen Content.md)** — evergreen anchors are the highest-ROI refresh candidates. Annual refresh on evergreen is part of the contract.
- **[03. Topic Clusters](03. Topic Clusters.md)** — refreshes are an opportunity to wire previously-orphaned posts into clusters.
- **[02. On-page SEO / 07. Content Optimization](../02. On-page SEO/07. Content Optimization.md)** — refresh execution at the on-page level (title, description, headers, body) uses these skills.
- **[02. On-page SEO / 05. Internal Linking](../02. On-page SEO/05. Internal Linking.md)** — refresh + internal-link updates go together.
- **[03. Technical SEO / 09. Site Migration](../03. Technical SEO/09. Site Migration.md)** — replace-and-301 refreshes touch redirect-mapping discipline.
