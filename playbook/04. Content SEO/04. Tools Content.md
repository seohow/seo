...
- **[03. Topic Clusters](03. Topic Clusters.md)** — tools work best as part of a cluster, not standalone.
- **[02. Pillar Pages](02. Pillar Pages.md)** — pillars are the content hub; tools are sometimes the *interactive* hub of the same cluster.
- **[02. On-page SEO / 05. Internal Linking](../02. On-page SEO/05. Internal Linking.md)** — tools need linking strategy more than blog content does (they're often the most-linkable page on the site).
- **[03. Technical SEO / 07. JavaScript SEO](../03. Technical SEO/07. JavaScript SEO.md)** — tools are JS-heavy; rendering / indexing matters.
- **[03. Technical SEO / 04. Schema Markup](../03. Technical SEO/04. Schema Markup.md)** — Article + WebApplication + FAQPage schema on the tool page.
