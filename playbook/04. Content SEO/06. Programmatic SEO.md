...
- **[03. Topic Clusters](03. Topic Clusters.md)** — programmatic templates can sometimes function as cluster spokes (glossary entries within an ingredients cluster).
- **[03. Technical SEO / 02. Indexing](../03. Technical SEO/02. Indexing.md)** — index control is critical for programmatic; thin pages should be `noindex`ed.
- **[03. Technical SEO / 04. Schema Markup](../03. Technical SEO/04. Schema Markup.md)** — most programmatic pages benefit from schema; deploy as part of the template.
- **[03. Technical SEO / 06. XML Sitemaps](../03. Technical SEO/06. XML Sitemaps.md)** — segment programmatic into its own sitemap for GSC analysis.
- **[02. On-page SEO / 04. URL Structure](../02. On-page SEO/04. URL Structure.md)** — programmatic URL patterns deserve deliberate design.
- **[02. On-page SEO / 05. Internal Linking](../02. On-page SEO/05. Internal Linking.md)** — programmatic linking is more complex than editorial; needs orchestrated patterns.
- **[03. Technical SEO / 08. Log File Analysis](../03. Technical SEO/08. Log File Analysis.md)** — programmatic crawl-budget consumption is real; logs help validate.
