...
- **[08. Content Briefing](08. Content Briefing.md)** — every post in the calendar gets briefed before it's written. The brief is the universal foundation across content types.
- **[02. Pillar Pages](02. Pillar Pages.md)** — most blog posts are spokes under a pillar. Pillar work is the architectural counterpart.
- **[03. Topic Clusters](03. Topic Clusters.md)** — the architectural pattern for how blog posts cluster around pillars.
- **[07. Content Refresh](07. Content Refresh.md)** — refresh-vs-new-post is a real trade-off. Often refreshing an existing post beats writing a new one.
- **[01. Strategy / 04. Keyword Clustering](../01. Strategy/04. Keyword Clustering.md)** — provides the cluster map that drives the calendar.
- **[02. On-page SEO / 07. Content Optimization](../02. On-page SEO/07. Content Optimization.md)** — when a blog post is published, on-page work happens via these skills.
