...
- **[03. Topic Clusters](03.%20Topic%20Clusters.md)** — pillars are the architectural unit; topic clusters are the broader pattern. Pair the two.
- **[01. Blog Content](01.%20Blog%20Content.md)** — most spokes are blog posts. Pillar work depends on the editorial calendar that produces spokes.
- **[05. Evergreen Content](05.%20Evergreen%20Content.md)** — pillars are usually evergreen by design; the longevity-first principles apply.
- **[08. Content Briefing](08.%20Content%20Briefing.md)** — every pillar needs a brief; the briefing skill is universal.
- **[02. On-page SEO / 05. Internal Linking](../02.%20On-page%20SEO/05.%20Internal%20Linking.md)** — pillar work depends on the linking plan. They feed each other.
- **[02. On-page SEO / 03. Header Structure](../02.%20On-page%20SEO/03.%20Header%20Structure.md)** — pillar pages depend on disciplined header structure more than any other content type.
- **[03. Technical SEO / 04. Schema Markup](../03.%20Technical%20SEO/04.%20Schema%20Markup.md)** — Article + FAQPage + BreadcrumbList schema on the pillar.
