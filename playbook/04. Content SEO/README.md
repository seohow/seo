...
- **[plan-blog-content](../../skills/content/plan-blog-content/SKILL.md)** — produce a 30/60/90-day blog editorial calendar from cluster map + business goals.
- **[design-pillar-page](../../skills/content/design-pillar-page/SKILL.md)** — produce a pillar-page brief: scope, outline, supporting spoke targets, cross-link strategy.
- **[design-topic-cluster](../../skills/content/design-topic-cluster/SKILL.md)** — convert a hub topic into a pillar + 5-10 spoke architecture.
- **[plan-tool-page](../../skills/content/plan-tool-page/SKILL.md)** — design a free-tool page (calculator, quiz, finder, generator) tied to a topical cluster.
- **[brief-evergreen-content](../../skills/content/brief-evergreen-content/SKILL.md)** — brief a longevity-first piece designed to compound for 3-5 years.
- **[plan-programmatic-seo](../../skills/content/plan-programmatic-seo/SKILL.md)** — evaluate whether programmatic SEO fits, design the data model + template approach if so.
- **[design-programmatic-template](../../skills/content/design-programmatic-template/SKILL.md)** — produce the actual template + data spec for programmatic page generation.
- **[plan-content-refresh](../../skills/content/plan-content-refresh/SKILL.md)** — analyse existing content for refresh candidates; produce a prioritised refresh backlog.
- **[generate-content-brief](../../skills/content/generate-content-brief/SKILL.md)** — universal content brief for any single piece (blog post, pillar, evergreen, refresh) — the foundation skill.
