...
- **[01. Blog Content](01.%20Blog%20Content.md)** — every blog post on the editorial calendar needs a brief.
- **[02. Pillar Pages](02.%20Pillar%20Pages.md)** — pillars get their own design brief via `design-pillar-page`; this skill produces the prose-level brief downstream of that.
- **[03. Topic Clusters](03.%20Topic%20Clusters.md)** — cluster architecture decides what content to produce; briefs spec how each piece is built.
- **[05. Evergreen Content](05.%20Evergreen%20Content.md)** — evergreen briefs are longer and emphasise longevity; uses `brief-evergreen-content` instead.
- **[07. Content Refresh](07.%20Content%20Refresh.md)** — refresh work uses gap-analysis briefs via `plan-content-refresh`; this skill is for new content.
- **[01. Strategy / 02. Search Intent](../01.%20Strategy/02.%20Search%20Intent.md)** — intent classification is a brief input.
- **[01. Strategy / 04. Keyword Clustering](../01.%20Strategy/04.%20Keyword%20Clustering.md)** — cluster placement is a brief input.
- **[02. On-page SEO / 07. Content Optimization](../02.%20On-page%20SEO/07.%20Content%20Optimization.md)** — on-page optimisation happens after the draft; brief inputs to it via the outline.
