...
- **[01. Blog Content](01. Blog Content.md)** — every blog post on the editorial calendar needs a brief.
- **[02. Pillar Pages](02. Pillar Pages.md)** — pillars get their own design brief via `design-pillar-page`; this skill produces the prose-level brief downstream of that.
- **[03. Topic Clusters](03. Topic Clusters.md)** — cluster architecture decides what content to produce; briefs spec how each piece is built.
- **[05. Evergreen Content](05. Evergreen Content.md)** — evergreen briefs are longer and emphasise longevity; uses `brief-evergreen-content` instead.
- **[07. Content Refresh](07. Content Refresh.md)** — refresh work uses gap-analysis briefs via `plan-content-refresh`; this skill is for new content.
- **[01. Strategy / 02. Search Intent](../01. Strategy/02. Search Intent.md)** — intent classification is a brief input.
- **[01. Strategy / 04. Keyword Clustering](../01. Strategy/04. Keyword Clustering.md)** — cluster placement is a brief input.
- **[02. On-page SEO / 07. Content Optimization](../02. On-page SEO/07. Content Optimization.md)** — on-page optimisation happens after the draft; brief inputs to it via the outline.
