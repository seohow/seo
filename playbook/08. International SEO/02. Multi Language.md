...
- **[01. Hreflang](01. Hreflang.md)** — Hreflang is required regardless of architecture.
- **[03. Geo Targeting](03. Geo Targeting.md)** — architecture is one of several geo-signals.
- **[04. Localization](04. Localization.md)** — content layer that fills the architecture.
- **[02. On-page SEO / 04. URL Structure](../02. On-page SEO/04. URL Structure.md)** — multi-market URL conventions live here.
- **[03. Technical SEO / 09. Site Migration](../03. Technical SEO/09. Site Migration.md)** — architecture migration is a major migration event.
