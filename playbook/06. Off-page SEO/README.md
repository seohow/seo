...
- Branded reputation → influences AI Overview / LLM citation ([09. AI SEO](../09.%20AI%20SEO/README.md) — planned).
- Authority signals → feed [10. Growth](../10.%20Growth/README.md) — planned (compound investments).

## Skills you'll use in this category

The full inventory across the 8 sub-topics:

- **plan-link-building-campaign** — strategic plan for a quarterly link-building effort, anchored to clusters + business goals.
- **plan-guest-posting-campaign** — guest-post target identification + pitch-angle planning.
- **plan-digital-pr-campaign** — design a digital PR campaign around an original-data / expert-commentary / newsworthy angle.
- **monitor-brand-mentions** — set up brand-mention tracking + unlinked-mention conversion flow.
- **design-outreach-process** — email templates, CRM, follow-up cadence, response handling.
- **set-up-haro-response-system** — reactive PR system: inbox monitoring, response templates, query filtering, response triage.
- **plan-broken-link-campaign** — broken-link prospecting + replacement-content pitch.
- **audit-branded-serp** — branded-SERP audit + reputation-management plan.
