...
- **[generate-title-tags](../../../skills/on-page/generate-title-tags/SKILL.md)** — takes a page URL (or proposed page), the target cluster, and the business profile; produces 4-6 scored title-tag variants with explicit reasoning, plus a recommendation. Optionally runs at list scale on a backlog of priority pages.
