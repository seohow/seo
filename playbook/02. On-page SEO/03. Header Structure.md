...
- **[01. Title](01. Title.md)** — the H1 often aligns with (but doesn't have to match) the meta title.
- **[07. Content Optimization](07. Content Optimization.md)** — header restructuring is usually paired with content rework; together they cover the page-body layer.
- **[03. Technical SEO / 04. Schema Markup](../03. Technical SEO/04. Schema Markup.md)** — FAQ-pattern H2s often pair with FAQPage schema for featured-snippet eligibility.
- **[01. Strategy / 04. Keyword Clustering](../01. Strategy/04. Keyword Clustering.md)** — cluster's supporting keywords drive what each H2 should target.
- **[09. AI SEO / 04. SERP Features](../09. AI SEO/04. SERP Features.md)** — featured snippets, People Also Ask, AI Overviews; structurally dependent on header patterns.
