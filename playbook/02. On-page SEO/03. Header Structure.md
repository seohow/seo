...
- **[01. Title](01.%20Title.md)** — the H1 often aligns with (but doesn't have to match) the meta title.
- **[07. Content Optimization](07.%20Content%20Optimization.md)** — header restructuring is usually paired with content rework; together they cover the page-body layer.
- **[03. Technical SEO / 04. Schema Markup](../03.%20Technical%20SEO/04.%20Schema%20Markup.md)** — FAQ-pattern H2s often pair with FAQPage schema for featured-snippet eligibility.
- **[01. Strategy / 04. Keyword Clustering](../01.%20Strategy/04.%20Keyword%20Clustering.md)** — cluster's supporting keywords drive what each H2 should target.
- **[09. AI SEO / 04. SERP Features](../09.%20AI%20SEO/04.%20SERP%20Features.md)** — featured snippets, People Also Ask, AI Overviews; structurally dependent on header patterns.
