...
- **[03. Technical SEO / 03. Site Speed](../03. Technical SEO/03. Site Speed.md)** — image optimization is the single largest lever for Core Web Vitals on most ecom sites.
- **[07. UX / 01. Page Speed UX](../07. UX/01. Page Speed UX.md)** — performance and the user-experience signal that flows from it.
- **[07. UX / 02. Mobile Optimization](../07. UX/02. Mobile Optimization.md)** — mobile-first means image optimization first.
- **[03. Technical SEO / 04. Schema Markup](../03. Technical SEO/04. Schema Markup.md)** — image-rich snippets (Product, Recipe) require structured data + optimized images.
- **[09. AI SEO / 04. SERP Features](../09. AI SEO/04. SERP Features.md)** — Google Image Search and image-rich results in AI Overviews.
