...
- **[03. Technical SEO / 03. Site Speed](../03.%20Technical%20SEO/03.%20Site%20Speed.md)** — image optimization is the single largest lever for Core Web Vitals on most ecom sites.
- **[07. UX / 01. Page Speed UX](../07.%20UX/01.%20Page%20Speed%20UX.md)** — performance and the user-experience signal that flows from it.
- **[07. UX / 02. Mobile Optimization](../07.%20UX/02.%20Mobile%20Optimization.md)** — mobile-first means image optimization first.
- **[03. Technical SEO / 04. Schema Markup](../03.%20Technical%20SEO/04.%20Schema%20Markup.md)** — image-rich snippets (Product, Recipe) require structured data + optimized images.
- **[09. AI SEO / 04. SERP Features](../09.%20AI%20SEO/04.%20SERP%20Features.md)** — Google Image Search and image-rich results in AI Overviews.
