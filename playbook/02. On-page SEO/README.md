...
- **generate-title-tags** — produce title-tag variants for a page, scored on relevance, intent fit, and CTR signal.
- **generate-meta-descriptions** — produce meta-description variants tuned to intent and brand voice.
- **audit-header-structure** — analyse H1/H2/H3 hierarchy of a page and propose a restructure.
- **define-url-conventions** — produce a URL-structure convention document for the site.
- **audit-urls** — review existing URLs against conventions, flag cleanup or migration candidates.
- **plan-internal-linking** — design a site-wide internal-linking strategy from the cluster map.
- **audit-page-internal-links** — review the links on and to a single page, recommend additions or removals.
- **audit-images** — analyse a page's images for alt text, file names, dimensions, format, and lazy-loading.
- **optimize-page-content** — rework a page's body content against a target cluster, intent, and brand voice.
