...
1. **[01. Title](01.%20Title.md)** — the single highest-leverage on-page element. The clickable string in the SERP and Google's strongest signal of what a page is about.
2. **[02. Descriptions](02.%20Descriptions.md)** — the snippet under the title in the SERP. Doesn't directly affect rankings but heavily affects click-through rate, which feeds back into rankings.
3. **[03. Header Structure](03.%20Header%20Structure.md)** — the H1/H2/H3 outline of the page. Tells Google how the content is organised and what each section is about.
4. **[04. URL Structure](04.%20URL%20Structure.md)** — the slug pattern used across the site. A site-level decision that affects every page.
5. **[05. Internal Linking](05.%20Internal%20Linking.md)** — how pages link to each other inside the site. Distributes ranking signal and helps Google understand topical relationships.
6. **[06. Image Optimization](06.%20Image%20Optimization.md)** — alt text, file names, formats, dimensions, lazy-loading. Affects accessibility, page speed, and image-search traffic.
7. **[07. Content Optimization](07.%20Content%20Optimization.md)** — the body content of the page itself: depth, structure, terminology, semantic coverage of the target topic.
...
- **[03. Technical SEO](../03.%20Technical%20SEO/README.md)** — make sure Google can actually crawl, index, and render the work you just did.
- **[04. Content SEO](../04.%20Content%20SEO/README.md)** — produce *new* pages for the clusters that don't yet have one.
- **[05. Analytics](../05.%20Analytics/README.md)** — measure rank, click, and traffic uplift on the pages you optimised so the next backlog is informed by evidence.
- **[01. Strategy / 05. SEO Wins](../01.%20Strategy/05.%20SEO%20Wins.md)** — re-score the backlog as on-page work ships, and queue the next round.
